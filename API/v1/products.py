...
class Product_Operation:
    ...
    def admin_create_product(self, name, units, price 
    ...
    def add_to_cart_by_id(self, product_id, quantity):
        ...
        if product_id > len(inventory):
            ...
            shopping_cart["total_price"] += quantity*inventory[product_id]["price"]
